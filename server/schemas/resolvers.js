//define the query and mutation functionality to work the Mongoose models
...
const resolvers = {
    Query: {
        ...
        user: async (parent, { username }) => {
            return User.findOne({_id }).select("-_ -password");
        },
        userById: async (parent, args) => {
            return User.findOne({ _id }).select("-_v -password");
        }
    },
    Mutation: {
